...
```ad-warning
Zorg dat je een loop van elke soort **altijd** afsluit. Anders loopt je code vast, met een risico dat je computer zelf ook vast loop door een verhoogd gebruik van RAM.
```
