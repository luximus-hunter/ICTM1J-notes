...
Dit is een `OR` operator. Maar in plaats van dat je een nieuwe `OR` toevoegt voor elke optie, geef je een lijst mee. Hiet kun je dus snel en makkelijk checke
